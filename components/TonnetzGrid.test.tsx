...
describe('TonnetzGrid click propagation', () => {
  ...
  it('calls onTogglePitchClass callback when the canvas is clicked at a valid node', () => {
    const handleToggle = vi.fn();
    const { container } = render(
      <TonnetzGridContainer onTogglePitchClass={handleToggle} />
    );
    ...
    // Since onTogglePitchClass is not passed to onToggleNote in TonnetzGrid yet,
