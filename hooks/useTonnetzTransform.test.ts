...
import { useTonnetzTransform } from './useTonnetzTransform';
...
describe('useTonnetzTransform - Phase 2 Core Matrix Operations', () => {
  ...
  it('Test Case 2 (Matrix 2): Given previous state r=4, F=1 (E Minor), When direction is UP, Assert r_new=4, F_new=0, and output is (4, 8, 11) or E Major', () => {
    const { result } = renderHook(() => useTonnetzTransform());
  ...
  it('Round trip: Given C Major (0, 4, 7), When navigated UP then DOWN, Assert it returns to C Major', () => {
    const { result } = renderHook(() => useTonnetzTransform());
  ...
  it('Round trip: Given C Major (0, 4, 7), When navigated RIGHT then LEFT, Assert it returns to C Major', () => {
    const { result } = renderHook(() => useTonnetzTransform());
  ...
  it('Round trip: Given C Major (0, 4, 7), When navigated LEFT then RIGHT, Assert it returns to C Major', () => {
    const { result } = renderHook(() => useTonnetzTransform());
  ...
  it('Round trip: Given C Major (0, 4, 7), When navigated DOWN then UP, Assert it returns to C Major', () => {
    const { result } = renderHook(() => useTonnetzTransform());
...
describe('useTonnetzTransform - PRP 19 Matrix 2 routing audit', () => {
  it('Test Case 1: Given Engine state r=9, F=1 (A Minor), When direction LEFT is triggered, Assert r_new=5, F_new=0 (F Major)', () => {
    const { result } = renderHook(() => useTonnetzTransform());
  ...
  it('Test Case 2: Given Engine state r=9, F=1 (A Minor), When direction UP is triggered, Assert r_new=9, F_new=0 (A Major)', () => {
    const { result } = renderHook(() => useTonnetzTransform());
